...
This document describes version 0.05 of Business::BankList::Indonesia (from Perl distribution Business-BankList-Indonesia), released on 2014-07-22.
...
=item * B<atmb_code.not_in> => I<array>
...
=item * B<fields> => I<array> (default: "name")
...
=item * B<nickname.not_in> => I<array>
...
Source repository is at L<https://github.com/sharyanto/perl-Business-BankList-Indonesia>.
